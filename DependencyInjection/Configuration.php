                ...
                ->children()
                            ...
                            ->arrayNode('registration')
                                ...
                                ->children()
                                    ->arrayNode('from_email')
                                        ...
                                        ->end()
                                    ->end()
                                    ->scalarNode('template')->defaultValue('SfynxAuthBundle:Registration:email.txt.twig')->end()
                                ->end()
                            ->end()
                            ->arrayNode('resetting')
                                ->addDefaultsIfNotSet()
                    ...
                    ->arrayNode('connexion')
                        ...
                        ->children()
                            ...
                            ->scalarNode('dashboard')->isRequired()->defaultValue('SfynxSmoothnessBundle::Login\\Security\\connexion-dashboard.html.twig')->cannotBeEmpty()->end()
