...
package {
	...
	public class ZeroClipboard extends Sprite {
		...
		protected function getProp( prop:String, opts:Array ):String
		{
			var i:int, iLen:int;
		...
		protected function configPdf():PDF
		{
			var
				pdf:PDF,
				i:int, iLen:int,
		 ...
		 * Inputs:   String
		 */
		protected function strToUTF8( str:String ):ByteArray {
		 ...
		 */
		protected function strToUTF16LE( str:String ):ByteArray {
